...
const Create = () => {
  ...
  const SubmitEvent = e => {
    e.preventDefault()
    if ( data.name === "" && data.email === "" && data.pwd === "" && data.gender === true ) return
    setSavedata([data, ...savedata])
    setData({ name : "", email : "", pwd : "", gender : true })
  }
  return (
    <div className="container mt-3">
      ...
      <form onSubmit={SubmitEvent}>
        ...
        <div className="d-flex">
          <div className="p-2 flex-fill">
            ...
            <input type="radio" className="form-check-input" id="radio1" name="gender" value="1" onChange={onChange}/>남성
            <label className="form-check-label" htmlFor="radio1"></label>
          </div>
          </div>
          <div className="p-2 flex-fill">
            <div className="form-check">
            <input type="radio" className="form-check-input" id="radio2" name="gender" value="2" onChange={onChange}/>여성
      ...
      <div className="d-flex">
        ...
        <div className="p-2 flex-fill d-grid">
          <button href="#" className="btn btn-primary">취소</button>
        </div>
      </div>
      <div>
        {
